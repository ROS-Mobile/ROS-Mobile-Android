 ...
 * @created on 18.10.19
 */
public class PhoneGpsView extends PublisherWidgetView {

    public static final String TAG = PhoneGpsView.class.getSimpleName();
    ...
    public PhoneGpsView(Context context) {
        super(context);
        init();
    }

    public PhoneGpsView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setWidgetEntity(BaseEntity widgetEntity) {
        ...
        PhoneGpsEntity joy = (PhoneGpsEntity) widgetEntity;
    ...
    private void moveTo(float x, float y) {
        posX = x;
        posY = y;
        this.publishViewData(new GPSData(posX, posY));
